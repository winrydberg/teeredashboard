        ...
        <div class="card">
            ...
            <div class="card-content collpase show">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form class="form form-horizontal" method="POST" action="#" id="theform"
                                id="addproductform">
                                {{csrf_field()}}
                                <div class="form-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control block" id="applicantlist" name="roles[]"
                                ...
                                <div class="form-actions center">
                                    ...
                                    <button type="button" id="btnSubmit" class="btn btn-primary submit">
                                        <i class="fa fa-check-square-o"></i> SEND SMS
                                    </button>
                                </div>
                            </form>
                        </div>
