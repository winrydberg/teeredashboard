      ...
      <div class="navbar-wrapper">
        ...
        <div class="navbar-container content">
          <div id="navbar-mobile" class="collapse navbar-collapse">
            ...
            {{-- <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="{{asset('assets/images/profile.png')}}" alt="avatar"><i></i></span><span class="user-name">
              edwin@gmail.com
            </span></a>
                        <div class="dropdown-menu dropdown-menu-right">
                          <div class="dropdown-divide"></div><a href{{Auth::guard('regulator')->user()->email}}</span></a>
                        <div class="dropdown-menu dropdown-menu-right">
